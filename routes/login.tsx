...
export default function Login(props: PageProps) {
  ...
  return (
    <Layout 
      isLoggedIn={false} 
      active="/login"
      title="Login | Fresh Auth"
      description="Log in to your Fresh Auth account"
      keywords="fresh, auth, login, signin"
      theme="light"
      showFooter={true}
    >
        ...
        <div class="w-full bg-white rounded-lg shadow-md max-w-md">
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form class="space-y-4 md:space-y-6" method="POST">
              ...
              <button type="submit" class="w-full text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Log In</button>
